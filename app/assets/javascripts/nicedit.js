...
var nicEditorButton = bkClass.extend({
	...
	setBg : function(state) {
		switch(state) {
			case 'hover':
				var stateStyle = {border : '1px solid #666', backgroundColor : '#ddd', opacity:"1.0"};
				break;
			case 'active':
				var stateStyle = {border : '1px solid #666', backgroundColor : '#ccc', opacity:"1.0"};
				break;
			default:
				var stateStyle = {border : '1px solid #efefef', backgroundColor : '#efefef', opacity:"0.6"};
		}
